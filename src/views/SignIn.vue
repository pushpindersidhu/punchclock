...
<template>
    <div
        class="z-10 flex h-screen w-screen items-center justify-center bg-white backdrop-blur dark:bg-black/50"
    >
        <div
        ...
        >
            ...
            <div class="mt-4 text-sm text-gray-400">
                ...
                <RouterLink to="/signup" class="text-amber-500 hover:underline">
                    Sign up
                </RouterLink>
            </div>
        </div>
